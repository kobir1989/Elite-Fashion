...
import {
  setToggleWishList,
  removeFromWishList
} from '../../../redux/features/wishList/wishLishSlice'
          ...
          <div className={styles.modal_content_wrapper}>
            ...
            <div className={styles.item_delete_button}>
              <Button
                ...
                onClick={e => removeHandler(e, list?.id)}
              >
      ...
      <div className={styles.message}>
        {wishListItem.length <= 0 && (
          <Typography color={'red'} variant={'body'}>
            Looks like you haven&apos;t created any wishlists yet. Why not start
            now and save your favorite products for later?
          </Typography>
        )}
      </div>
    </div>
