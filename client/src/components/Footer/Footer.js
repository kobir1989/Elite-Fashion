    ...
    <footer>
        ...
        <div className={styles.footer_contract_wrapper}>
          ...
          <ul>
            <li>
              ...
              <a href='mailto:Kobir.h.ritu@gmail.com'>
                {' '}
              ...
              <div className={styles.social_icons}>
                ...
                <span>
                  <a
                    ...
                    rel='noopenar noreferrer'
                  >
                    <Icons name={'linkedIn'} size={'1.5rem'} color={'#fff'} />
                  </a>
                </span>
                <span>
                  <a
                ...
                <span>
                  <a
                    ...
                    rel='noopenar noreferrer'
                  >
                    <Icons name={'gitHub'} size={'1.5rem'} color={'#fff'} />
                  </a>
                </span>
              </div>
            </li>
      ...
      <div className={styles.footer_copyright}>
        ...
        <Typography color={'white'} variant={'small'}>
          Copyright &copy; {new Date().getFullYear()} | Kabir Hossain
        </Typography>
      </div>
    </footer>
  )
