      ...
      <div className={styles.nav}>
        ...
        <div className={styles.nav_buttons}>
          ...
          <div className={styles.chat_popup_button}>
            <Button variant={'icon-btn-normal'} onClick={handleToggleChatModal}>
              <Icons name={'chatIcon'} size={'1.5rem'} />
              <span className={styles.message_count}>{isMessage}</span>
            </Button>
          </div>
          <div className={styles.wish_list_btn_wrapper}>
            <Button
              variant={'icon-btn-normal'}
              onClick={() => {
                dispatch(setToggleWishList(!toggleWishList))
              }}
            >
          ...
          <div className={styles.cart_item_link_wrapper}>
            <Link to={'/cart'}>
              ...
              <span className={styles.cart_item_count}>{quantity}</span>
            </Link>
          </div>
        </div>
      </div>
