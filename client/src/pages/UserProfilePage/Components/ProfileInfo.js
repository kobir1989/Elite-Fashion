  ...
  return (
    <div className={styles.profile_info}>
      <div className={styles.profile_img}>
        <img
          src={userProfileData?.profilePic || '/assets/user.jpg'}
          alt='user.png'
        />
      </div>
      {isLoading ? (
        ...
        <ul>
          <li>
            ...
            <Typography variant={'body'}>{userProfileData?.name}</Typography>
          </li>
          <li>
            <Typography variant={'body'}>Email:</Typography>
            <Typography variant={'body'}>{userProfileData?.email}</Typography>
          </li>
          <li>
