      ...
      <section className={styles.banner_section}>
        ...
        {userInfo ? (
          <Banner
            ...
            subTitle={
              "Step out in style with the latest haute couture and luxury fashion pieces from the world's top designers"
            }
          ...
          <Banner
            title={
              "New members get 10% off their first purchase! Not a member yet? Join now, it's free."
            }
            subTitle={
              'We always offer free standard delivery and Click & Collect for orders over $20 for Members. Returns are free and flexible.'
            }
