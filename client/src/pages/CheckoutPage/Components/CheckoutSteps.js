      ...
      {isCompliteSteps() ? (
        <div className={styles.success_message}>
          ...
          <Typography variant={'h4'}>
            ...
            <br /> Your stylish new clothes will be on their way soon. Shop
            again for more fashion inspiration!
          </Typography>
          <Button variant={'primary'} onClick={handleSuccessPayment}>
            Ok
          </Button>
        </div>
      ) : (
        <div className={styles.steps_components}>
          {activeStep === 0 && <ShippmentForm />}
          {activeStep === 1 && (
            <OrderDetails onBack={backHandler} onNext={nextStepHandler} />
          )}
